    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
            ...
            <div className="text-center mb-10">
                <h1 className="text-3xl font-bold text-gray-900 mb-2">Seu Protocolo Exclusivo</h1>
                <p className="text-gray-500">Desenvolvido com base no seu perfil metabólico e hormonal</p>
            </div>
